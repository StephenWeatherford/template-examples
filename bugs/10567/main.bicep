...
~/repos/bicep/src/Bicep.Cli/bin/Debug/net7.0/bicep publish ~/repos/template-examples/bugs/10567/main.bicep --target br:sawbicep.azurecr.io/storage:test --documentationUri https://www.contoso.com/exampleregistry.html
